...
var nodeUrl__default = _interopDefault(nodeUrl);
...
var nodeStream__default = _interopDefault(nodeStream);
...
const { URL: URL$1, URLSearchParams } = nodeUrl__default;
...
const { URLSearchParams: URLSearchParams$1 } = nodeUrl__default;
...
const { URL: URL$2, URLSearchParams: URLSearchParams$2 } = nodeUrl__default;
...
const { URL: URL$3, URLSearchParams: URLSearchParams$3 } = nodeUrl__default;
...
const { URL: URL$4, URLSearchParams: URLSearchParams$4 } = nodeUrl__default;
...
const { URL: URL$5, URLSearchParams: URLSearchParams$5 } = nodeUrl__default;
...
const { Stream } = nodeStream__default;
...
class MultipartStream extends sandwichStream.SandwichStream {
     ...
     */
    addPart(part) {
        const partStream = new nodeStream.PassThrough();
        if ('headers' in part) {
...
const { Readable } = nodeStream__default;
...
const { URL: URL$6, URLSearchParams: URLSearchParams$6 } = nodeUrl__default;
...
const { URL: URL$7 } = nodeUrl__default;
...
const { URL: URL$8, URLSearchParams: URLSearchParams$7 } = nodeUrl__default;
...
class KeyboardBuilder {
    ...
    payButton({ hash: rawHash }) {
        const hash = typeof rawHash === 'object'
            ? String(new nodeUrl.URLSearchParams(Object.entries(rawHash)))
            : rawHash;
        return this.addWideButton({
            action: {
                hash,
