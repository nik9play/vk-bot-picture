 ...
 * ```
 */
const getLazyMiddleware = (factory) => (async (context, next) => {
...
export { Composer, compose, getAfterMiddleware, getBeforeMiddleware, getBranchMiddleware, getConcurrencyMiddleware, getEnforceMiddleware, getFilterMiddleware, getForkMiddleware, getLazyMiddleware, getOptionalMiddleware, getTapMiddleware, noopNext, skipMiddleware, stopMiddleware };
